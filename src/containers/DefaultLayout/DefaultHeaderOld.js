...
import logo from '../../assets/img/brand/banijjoLogo.png';
import adminLogo from '../../assets/img/banijjoAdminLogo.PNG';
  ...
  render() {
    ...
    return (
      <React.Fragment>
        ...
        <AppNavbarBrand
          full={{ src: logo, width: 120, height: 50, alt: 'Banijjo Logo' }}
          minimized={{ src: sygnet, width: 30, height: 30, alt: 'Banijjo Logo' }}
        />
...
{/* 
        ...
        <Nav className="ml-auto" navbar>
          ...
          <UncontrolledDropdown nav direction="down">
            <DropdownToggle nav>
              <img src={adminLogo} className="img-avatar" alt="banijjo@admin.com" />
            </DropdownToggle>
            <DropdownMenu right>
