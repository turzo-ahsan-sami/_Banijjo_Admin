...
class Rogistar extends Component {
  ...
  handleClick(){
    ...
    fetch('/api/vendor-details-personal' , {
      method: "POST",
      headers: {
  ...
  handleClickThree () {
    ...
    fetch('/api/vendor-details-business' , {
      method: "POST",
      headers: {
        'Content-type': 'application/json'
      },
  ...
  handleChildCategory = (event) => {
    ...
    fetch(`/api/child-category/?id=${event.target.value}`, {
      method: 'GET'
    })
    .then(res => {
      console.log(res);
